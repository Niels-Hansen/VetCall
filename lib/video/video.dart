...
const String token = '0060deef447329443ef8549b9f563c38a51IADPL65Fmb34eMWVaHgssvA8q2SaGSFd6Z3K7Y9VQc0l4wrCxmsAAAAAEAD3dRUDUqWGYQEAAQBTpYZh';
...
class VideoConferenceState extends State<VideoConference>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Center(child: renderRemoteVideo(),
          ),
          Align(
